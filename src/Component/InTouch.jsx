    ...
    <div className='bg-blue-900'>
        <div className="bg-gray-300 w-full h-[471px] top-[4061px] rounded-[92px_0px_92px_0px]">
            <div className="relative">
                ...
                <div className="absolute inset-0 flex flex-col pb-20 items-center justify-center text-white z-10">
                ...
                <input 
                  ...
                  className="flex-grow p-2 rounded-l-md text-gray-400 focus:outline-none"
                  value={email}
                  onChange={(e) => setEmail(e.target.value)}
                  required
                />
                <button type="submit" className="bg-white mr-10 text-blue-900 px-4 py-2 rounded-r-md font-semibold">
                  Sent
                </button>
              </form>
