...
const Hero1 = () => {
  return (
    <section className='bg-slate-200'>
      <div className="bg-blue-950 text-white px:4 md:px-20 rounded-bl-[80px]">
      <div className="flex justify-between flex-col md:flex-row">
        <div className="w-full md:w-1/2 py-10 md:py-32 px-12 order-2 md:order-1">
          <div className="inline-block">
            ...
            <h1 className="font-bold text-2xl md:text-5xl w-full mt-4">
              {" "}
              Online Courses
            </h1>
            <h1 className="font-bold text-2xl md:text-4xl w-full mt-4">
              {" "}
              From ANi Educations
            </h1>
        ...
        <div className="md:w-1/2 mt-5 md:mt-10 pt-6 order-1 md:order-2">
          <div className="relative h-full w-full flex justify-center items-center ">
            ...
            <img
              ...
              className="absolute w-[550px] -top-24 right-4 md:right-6 z-0"
            />
          </div>
        </div>
      </div>
